...
class Gojek
{
    ...
    {
        $this->sessionId = '91BFBED5-96F7-4376-AD05-F54C0846C598'; // generated from self::uuidv4();
        $this->uniqueId = '0F38DBDC-BCF5-445B-9410-D68714632966'; // generated from self::uuidv4();
        if ($authToken) {
